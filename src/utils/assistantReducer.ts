...
import type { AssistantConfig } from "../lib/naggingAssistantClient";
import { requestAssistantCompletion } from "../lib/naggingAssistantClient";
import {
...
export function useAssistant(assistantConfig: AssistantConfig) {
  ...
  const submitAssistantPrompt = useCallback(
    ...
    [
      assistantConfig,
      hasEndpointAndModel,
      state.assistantWindowVisible,
      state.assistantWindowText,
    ],
  );
