...
const runtimeConfig: RuntimeConfig = Object.freeze({
  ...
  firebase: Object.freeze({
    ...
    storageBucket: readOptionalEnv(import.meta.env.VITE_FIREBASE_STORAGE_BUCKET),
    messagingSenderId: readOptionalEnv(import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID),
    appId: readOptionalEnv(import.meta.env.VITE_FIREBASE_APP_ID),
    measurementId: readOptionalEnv(import.meta.env.VITE_FIREBASE_MEASUREMENT_ID),
  }),
});
